  ...
  return (
    <View style={{ width: '100%' }}>
      ...
      {labelTitle ? <View style={{ flexDirection: 'row' }}>
        <CustomText text={labelTitle} fontFamily={Fonts.PoppinsMedium} textSize={FontsSize._14_SIZE} textColor={colors.textColor02} marginBottom={4}></CustomText>
        <Sizebox width={5}></Sizebox>
        {labelTitleRequired ? <CustomText text={"*"} fontFamily={Fonts.PoppinsMedium} textSize={FontsSize._14_SIZE} textColor={colors.alertColor} marginBottom={4}></CustomText> : null}
      </View> : null}
      <View
        style={[
