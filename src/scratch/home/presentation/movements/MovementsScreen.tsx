...
import { DateGroup, Movements, MovementsItem } from '../components/MovementsItem';
...
export const MovementsScreen = observer(() => {
  ...
  const dateGroup: DateGroup[] = movements.reduce((groups, notification) => {
    const date = new Date("2024-06-10T09:35:24");
  ...
  const movementsGroup: Map<string, Movements[]> = new Map();
  ...
  const renderItem = ({ item }: any) => {
    ...
    return (
      <View>
        ...
        {item[1].map((notification: Movements) => (
